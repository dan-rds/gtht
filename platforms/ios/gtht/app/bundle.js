...
const accelerometer = __webpack_require__("nativescript-accelerometer");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data() {
    return {
      categoricalSource: [{
        Name: "X-axis",
        Amount: 2 //Amount: this.accelerometerValues.x

      }, {
        Name: "Y-axis",
        Amount: 2 //Amount: this.accelerometerValues.y
            ...
            [
              _c("Button", {
                attrs: {
                  ...
                  visibility: _vm.accelerometerValues.x
                    ? "collapsed"
                    : "visible"
                },
                on: { tap: _vm.startAccelerometer }
              }),
              _c(
                "StackLayout",
                {
                ...
                [
                  _c("Label", {
                    attrs: { text: "X: " + _vm.accelerometerValues.x }
                  }),
                  _c("Label", {
                    attrs: { text: "Y: " + _vm.accelerometerValues.y }
                  }),
                  _c("Label", {
                    attrs: { text: "Z: " + _vm.accelerometerValues.z }
                  })
                ],
                1
              ),
